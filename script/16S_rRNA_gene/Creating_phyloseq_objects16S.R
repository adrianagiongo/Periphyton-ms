...
otu_mat<-read_excel("~/Documents/R_analysis_2/Perifiton/Perifiton_16S/data/Perifiton_otu.xlsx")
taxo_mat<-read_excel("~/Documents/R_analysis_2/Perifiton/Perifiton_16S/data/Perifiton_taxa.xlsx")
metadata<-read.csv("~/Documents/R_analysis_2/Perifiton/Perifiton_16S/data/Perifiton_metadata.csv", row.names = 1)
...
Perifiton16S_data<-phyloseq(OTU, TAX, SAMPLE)

#visualise phyloseq-class
Perifiton16S_data

#visualise data
sample_names(Perifiton16S_data)
rank_names(Perifiton16S_data)
sample_variables(Perifiton16S_data)
